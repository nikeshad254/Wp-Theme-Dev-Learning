                ...
                <div class="one-third">
                  ...
                  ${
                    results.events.length
                      ? ""
                      : `<p>No Events matches that search. <a href="${universityData.root_url}/events">View all campuses</a></p>`
                  }
                      ...
                      (item) =>
                        `<div class="event-summary">
                            ...
                            <div class="event-summary__content">
                                <h5 class="event-summary__title headline headline--tiny"><a href="${item.permaLink}"><?php ${item.title}?></a></h5>
