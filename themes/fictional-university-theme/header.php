...
<body <?php body_class() ?>>
    <header class="site-header">
        <div class="container">
            ...
            <a href="<?= esc_url(site_url('/search')) ?>" class="js-search-trigger site-header__search-trigger"><i class="fa fa-search"
            ...
            <div class="site-header__menu group">
                ...
                <div class="site-header__util">
                    ...
                    <a href="<?= esc_url(site_url('/search')) ?>" class="search-trigger js-search-trigger"><i class="fa fa-search"
                            aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
