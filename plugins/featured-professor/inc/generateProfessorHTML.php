...
function generateProfessorHTML($id)
{
    ...
    while ($profPost->have_posts()) {
        ...
        <div class="professor-callout">
            <div class="professor-callout__photo" style="background-image: url(<?= get_the_post_thumbnail_url(); ?>)"></div>
            <div class="professor-callout__text">
                ...
                <p><strong><a href="<?= get_the_permalink(); ?>">Learn more about <?php the_title(); ?> &raquo;</a></strong></p>
            </div>
        </div>
<?php
        wp_reset_postdata();
